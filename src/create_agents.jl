...
100-element Array{Agent,1}:
 ABM4OSN.Agent(-0.21358598875747914, 0.24040808640140598, -0.21358598875747914, 0.946685901388097, true, 0, ABM4OSN.Tweet[], ABM4OSN.Tweet[], ABM4OSN.Tweet[])
 ABM4OSN.Agent(-0.4168976786164982, 0.19897621172267413, -0.4168976786164982, 0.9528034729915846, true, 0, ABM4OSN.Tweet[], ABM4OSN.Tweet[], ABM4OSN.Tweet[])
 ⋮
```
...
3-element Array{ABM4OSN.Agent,1}:
 ABM4OSN.Agent(0.6472950159548247, 0.02917756427881842, 0.6472950159548247, 0.9983073811302889, true, 0, ABM4OSN.Tweet[], ABM4OSN.Tweet[], ABM4OSN.Tweet[])
 ABM4OSN.Agent(-0.6453423070674709, 0.3967140625022613, -0.6453423070674709, 0.9974123306454633, true, 0, ABM4OSN.Tweet[], ABM4OSN.Tweet[], ABM4OSN.Tweet[])
 ABM4OSN.Agent(-0.9153966681359407, 0.8339233629392565, -0.9153966681359407, 0.9918175134767683, true, 0, ABM4OSN.Tweet[], ABM4OSN.Tweet[], ABM4OSN.Tweet[])
```
